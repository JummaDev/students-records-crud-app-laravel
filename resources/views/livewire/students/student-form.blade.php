<div class="max-w-2xl mx-auto p-6 sm:p-8 space-y-6">
    ...
    <div class="pb-5 border-b border-gray-200">
        <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Add New Teacher</h2>
        <p class="text-sm text-gray-500 mt-1">Register a new educator profile and assign their primary subject department.</p>
    </div>

    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        <form wire:submit.prevent="submit" class="p-6 sm:p-8 space-y-5">
            ...
            <div class="space-y-1.5">
                <label for="subject" class="block text-sm font-semibold text-gray-700">Subject / Department</label>
                <input 
                    type="text" 
                    id="subject" 
                    wire:model="subject" 
            ...
            <div class="pt-4 flex items-center justify-end space-x-3 border-t border-gray-100">
                ...
                >
                    <svg wire:loading wire:target="submit" class="animate-spin -ml-1 mr-2.5 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24">
